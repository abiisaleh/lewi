...
<head>
    ...
    <title><?= $title ?> - Monitoring SMA</title>
    <base href="<?= base_url() ?>">
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item has-sub" id="Data Pelanggaran">
                        ...
                        <li class="sidebar-item" id="Data Siswa">
                        ...
                        <li class="sidebar-item" id="Data Guru">
                        ...
                        <li class="sidebar-item" id="Data Akademik">
                        ...
                        <li class="sidebar-item" id="Jadwal Pelajaran">
