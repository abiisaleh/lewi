...
<body>
    ...
    <div id="app">
        ...
        <?= (logged_in()) ? $this->include('admin/_sidebar') : '' ?>

        <div id="main" class="<?= (logged_in()) ? 'layout-navbar navbar-fixed' : 'layout-horizontal' ?>">
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-8 col-sm-6 order-md-1 order-last">
                                <h3><?= $title ?></h3>
                                <p class="text-subtitle text-muted"><?= $subtitle ?? null ?></p>
                            </div>
